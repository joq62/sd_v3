...
start_2_test([N0,N1,N2],HostName)->
    ...
    [{'n0@c100',"c100"},{'n2@c100',"c100"}]=sd:get_node(test_add),
    [{'n1@c100',"c100"},{'n2@c100',"c100"}]=sd:get_node(test_divi),  
    []=sd:get(glurk), 
    [{'n0@c100',"c100"},{'n2@c100',"c100"}]=sd:get_node_on_host(test_add,HostName),
    [{'n1@c100',"c100"},{'n2@c100',"c100"}]=sd:get_node_on_host(test_divi,HostName),
    []=sd:get_node_on_host(test_divi,"glurk_hostname"),
    []=sd:get_node_host_host(glurk,HostName),
...
start_1_test([N0,N1,N2],HostName)->
    ...
    [{'n0@c100',"c100"}]=sd:get_node(test_add),
    [{'n1@c100',"c100"}]=sd:get_node(test_divi),  
    []=sd:get(glurk), 
    [{'n0@c100',"c100"}]=sd:get_node_on_host(test_add,HostName),
    [{'n1@c100',"c100"}]=sd:get_node_on_host(test_divi,HostName),
    []=sd:get_node_on_host(test_divi,"glurk_hostname"),
